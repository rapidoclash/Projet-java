...
public class Liche extends Enemy{
    ...
    public Liche(float HP, float dgt,float x, float y ,float vx, float vy) throws SlickException {
    	super(HP, dgt, x, y, vx, vy);
    	Image = new Image("image/liche_gauche.png");
    ...
    public void afficher(Graphics g) {
    	if (this.enVie()) {
			...
			g.fillRect(x+2, y+2,Math.max((((int)(Image.getWidth())-4)*HP)/HPmax, 0) ,3);
    			...
    			Image.draw(x, sk, (int) (Image.getWidth() ), (int) (Image.getHeight()));
    }
